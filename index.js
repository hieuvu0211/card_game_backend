...
app.get('/getuserbyid/:id', getPlayerById)
app.get("/getuserbyname/:name", getPlayerByName)
//user register
...
app.put("/updateskinuser/:id/:newid", updateCurrentSkin)
...
app.get("/getskinbyid/:id", getSkinById)
//add new skin
...
//----------------------------------------------------------------------------------------------
//add new skin_user
app.get("/getskinbyidplayer/:id", GetSkinById)
...
app.get("/getmatchparticipantbyid/:match_id", getMatchParticipantById);
...
app.get("/getalldeposithistory/:id", getDepositById);
