    ...
    <div id="chat" className="flex flex-col fixed left-0 h-full w-96 items-center justify-center pl-2">
      ...
      <input type="text" placeholder="Type here" value={chat} onChange={e => setChat(e.currentTarget.value)} onKeyDown={handleKeyDown} className=" w-full bg-slate-700 opacity-75 h-10 pl-2 rounded-x-md rounded-b-md"></input>
        ...
        <div className=" flex flex-col w-full p-2 m-1 items-center justify-center">
          <div className="text-white bg-gray-900 hover:bg-slate-300 hover:text-gray-900 shadow-black shadow-md font-bold m-1 w-96 h-14 flex justify-center items-center rounded-3xl">FIND GAME</div>
          <Link className="text-white bg-gray-900 hover:bg-slate-300 hover:text-gray-900 shadow-black shadow-md font-bold m-1 w-96 h-14 flex justify-center items-center rounded-3xl" href='/create_room'>CREATE ROOM</Link>
          <Link href="/find_room" className={"text-white bg-gray-900 hover:bg-slate-300 hover:text-gray-900 shadow-black shadow-md font-bold m-1 w-96 h-14 flex justify-center items-center rounded-3xl"}>FIND ROOM</Link>
          <button onClick={() => handleModal()} className="text-white bg-gray-900 hover:bg-slate-300 hover:text-gray-900 shadow-black shadow-md font-bold m-1 w-96 h-14 flex justify-center items-center rounded-3xl">RULES</button>
        </div>
    </div>
